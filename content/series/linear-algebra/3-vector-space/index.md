...
For example, $V = \mathcal{L} \left( (1, 1, 1, 1)^\prime, (1, 1, -1, -1)^\prime \right)$. We first take two linearly independent vectors that are not in $V$, e.g. $(1, 0, 0, 0)^\prime$ and $(0, 0, 1, 0)^\prime$. Then,
...
$$
\begin{gathered}
    \boldsymbol{v}_3 = \left( \frac{1}{2}, -\frac{1}{2}, 0, 0 \right)^\prime \\\\
    \boldsymbol{v}_4 = \left( 0, 0, \frac{1}{2}, -\frac{1}{2} \right)^\prime
\end{gathered}
$$
